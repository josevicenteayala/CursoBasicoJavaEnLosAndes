...
public class ImagenTest extends TestCase
{
    ...
    public void testCargaImagenPequenia( )
    {
        ...
        //los l�mites de la imagen deben ser menores a los m�ximos
    ...
    /**
     * Prueba la carga de una imagen mayor al m�ximo
     */
    public void testCargaImagenGrande( )
    {
        ...
        //El ancho y alto de la imagen original son mayores a los m�ximos
        assertTrue( ancho > Imagen.ANCHO_MAXIMO );
        assertTrue( alto > Imagen.ALTO_MAXIMO );

        //El ancho y el alto de la imagen cargada deben ser los m�ximos
        //porque se trunca
